...
public class JedisOperatorUtil {
	...
	private static JedisOperatorUtil temp_jedis = null;
	private Jedis jedis = null;
	// 负责同步
	private static Lock lock = new ReentrantLock();

	public static JedisOperatorUtil getInstance() {
		if(temp_jedis == null){
			try {
				lock.lock();
				if(temp_jedis == null){
					temp_jedis = new JedisOperatorUtil(SystemParas.redis_host,
	...
	private JedisOperatorUtil(String host, int port, String redis_password) {
	...
	public boolean putObj(String key, int seconds, String value) {
		try {
